...
const AdminApplicationDetail = () => {
  ...
  if (loading) return <div className="container mt-20">Loading Application Details...</div>;
  if (error) return <div className="container mt-20 text-danger">{error}</div>;
  if (!application) return <div className="container mt-20">Application not found.</div>;
  ...
  return (
    <div className="admin-detail container mt-20 mb-20">
      <div className="flex justify-between items-center mb-20">
        ...
        <div className="flex gap-10">
          ...
          <button onClick={() => updateStatus('accepted')} className="btn" style={{ backgroundColor: '#dcfce7', color: '#166534', padding: '8px 15px', fontSize: '0.9rem' }}>Accept Application</button>
          <button onClick={() => updateStatus('rejected')} className="btn" style={{ backgroundColor: '#fee2e2', color: '#991b1b', padding: '8px 15px', fontSize: '0.9rem' }}>Reject Application</button>
        </div>
      </div>
      ...
      <div className="flex gap-20 flex-col-mobile">
        ...
        <div style={{ flex: 1 }}>
          ...
          <div className="card mb-20" style={{ textAlign: 'center', position: 'sticky', top: '20px' }}>
            <h3 style={{ marginBottom: '15px' }}>Application Status</h3>
            <div style={{
