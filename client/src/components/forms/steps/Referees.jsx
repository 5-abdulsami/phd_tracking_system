  ...
  return (
    <div className="section-form">
       <p className="mb-20" style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
        Please provide details for up to 3 academic or professional referees.
       </p>
      {data.map((item, index) => (
        <div key={index} className="card mb-20" style={{ backgroundColor: '#f9fafb', border: '1px solid #eee' }}>
          <div className="flex justify-between items-center mb-10">
            <h4 style={{ fontSize: '1rem' }}>Referee #{index + 1}</h4>
            <button onClick={() => removeReferee(index)} style={{ color: 'var(--danger)', background: 'none' }}>
              <Trash2 size={18} />
            </button>
          </div>
          <div className="grid gap-20" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div className="form-group">
              <label className="block mb-10 font-600">Full Name</label>
              <input 
                type="text" 
                name="name"
                value={item.name} 
            ...
            <div className="form-group">
              <label className="block mb-10 font-600">Designation</label>
              <input 
                type="text" 
                name="designation"
            ...
            <div className="form-group">
              <label className="block mb-10 font-600">Institution / Organization</label>
              <input 
                type="text" 
                name="institution"
             ...
             <div className="form-group">
              <label className="block mb-10 font-600">Relationship</label>
              <input 
                type="text" 
                name="relation"
                value={item.relation} 
            ...
            <div className="form-group">
              <label className="block mb-10 font-600">Email Address</label>
              <input 
                type="email" 
                name="email"
                value={item.email} 
            ...
            <div className="form-group">
              <label className="block mb-10 font-600">Phone Number</label>
              <input 
                type="text" 
                name="phone"
                value={item.phone} 
